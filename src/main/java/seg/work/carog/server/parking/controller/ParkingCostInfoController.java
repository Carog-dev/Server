...
public class ParkingCostInfoController {
    ...
    @DeleteMapping("/{carInfoId}/{parkingCostInfoId}")
    public ResponseEntity<?> deleteParkingCostInfo(TokenUserInfo tokenUserInfo, @PathVariable Long carInfoId, @PathVariable Long parkingCostInfoId) {
        parkingCostInfoService.deleteParkingCostInfo(tokenUserInfo, carInfoId, parkingCostInfoId);
