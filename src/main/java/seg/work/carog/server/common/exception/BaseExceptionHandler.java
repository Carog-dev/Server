...
public class BaseExceptionHandler {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> handleRuntimeException(Exception ex) {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> methodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        return new ResponseEntity<>(BaseApiResponse.error(statusInfo, errors), statusInfo.getHttpStatus());
    }

    @ExceptionHandler(ConstraintViolationException.class)
    public ResponseEntity<BaseApiResponse<Map<String, String>>> onConstraintValidationException(ConstraintViolationException ex) {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> httpMessageNotReadableException(HttpMessageNotReadableException ex) {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> badCredentialsException(BadCredentialsException ex) {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> methodNotAllowedException(MethodNotAllowedException ex) {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException ex) {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> missingServletRequestParameterException(Exception ex) {
    ...
    public ResponseEntity<BaseApiResponse<Map<String, String>>> handleBaseException(BaseException be) {
